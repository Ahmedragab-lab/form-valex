				...
				<ul class="side-menu">
					...
					<li class="slide">
                        <a class="side-menu__item" href="#">
                           <span class="side-menu__label "> <h4> <i class="icon ion-ios-home ml-2"></i> الرئيسيه</h4></span>
                        </a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="#">
                                <span class="side-menu__label"> <h5><i class="si si-user ml-2"></i>المشرفين  </h5></span>
                        </a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="#">
                                <span class="side-menu__label"> <h5><i class="si si-people ml-2"></i>المستخدمين </h5></span>
                        </a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ route('section.index') }}">
                                <span class="side-menu__label"> <h5><i class="far fa-address-card ml-2"></i>الاقسام </h5></span>
                        </a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ route('product.index') }}">
                                <span class="side-menu__label"> <h5><i class="si si-menu ml-2"></i>المنتجات </h5></span>
                        </a>
					</li>
